...
#lightdm.conf greeter-session
oldname11='#greeter-session=example-gtk-gnome'
newname11='greeter-session=lightdm-deepin-greeter'
...
sed -i 's/'$oldname11'/'$newname11'/g' ../work/archiso/airootfs/etc/lightdm/lightdm.conf
